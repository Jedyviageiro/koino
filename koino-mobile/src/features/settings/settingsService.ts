...
import type { FriendshipListItem, FriendshipResult, LocalPreferences, PublicProfile, UserSettings } from './types';
...
export function getFriends() { return authenticatedRequest<FriendshipListItem[]>('/users/me/friends'); }
