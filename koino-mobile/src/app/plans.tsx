...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  title: { color: '#111820', fontSize: layout.titleSize, lineHeight: 37, fontWeight: '800' },
  ...
  sectionTitle: { color: '#121820', fontSize: 21, fontWeight: '700' },
  ...
  currentName: { color: '#121820', fontSize: 19, fontStyle: 'italic', fontWeight: '700' },
  ...
  planTitle: { color: '#121820', fontSize: 18, fontStyle: 'italic', fontWeight: '700' },
