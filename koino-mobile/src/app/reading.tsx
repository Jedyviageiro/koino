...
const styles = StyleSheet.create({
  ...
  errorBanner: { marginHorizontal: 16, marginBottom: 7, paddingHorizontal: 13, paddingVertical: 9, borderRadius: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#f4f5f6' },
  errorText: { flex: 1, color: '#5f6977', fontSize: 11, lineHeight: 16 },
