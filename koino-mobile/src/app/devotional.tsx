...
const styles = StyleSheet.create({
  ...
  dayTitle: { marginTop: 7, color: '#101820', fontSize: 32, fontStyle: 'italic', fontWeight: '700' },
  ...
  title: { marginTop: 15, color: '#101820', fontSize: 32, lineHeight: 40, fontStyle: 'italic', fontWeight: '700' },
