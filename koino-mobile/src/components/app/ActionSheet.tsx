...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 16, color: '#151c24', fontSize: 20, fontWeight: '700', textAlign: 'center' },
  ...
  dangerIcon: { backgroundColor: '#fff0ee' }, actionLabel: { flex: 1, color: '#202832', fontSize: 14, fontWeight: '600' }, danger: { color: '#a83b35' },
  cancel: { height: 50, marginTop: 10, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: '#f4f5f6' }, cancelText: { color: '#303944', fontSize: 14, fontWeight: '700' },
