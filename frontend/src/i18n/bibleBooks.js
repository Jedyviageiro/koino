const portugueseBooks = {
  ...
  'Song of Solomon': 'Cântico dos Cânticos', Isaiah: 'Isaías', Jeremiah: 'Jeremias',
  Lamentations: 'Lamentações', Ezekiel: 'Ezequiel', Daniel: 'Daniel', Hosea: 'Oseias',
  Joel: 'Joel', Amos: 'Amós', Obadiah: 'Obadias', Jonah: 'Jonas', Micah: 'Miqueias',
...
export function localizedBibleBook(title, language) {
  return String(language || '').toLowerCase().startsWith('pt')
    ? portugueseBooks[title] || title
    : title
}
